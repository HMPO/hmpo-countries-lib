'use strict';
// Country codes to exclude from overseas residence countries
const EXCLUDED_OVERSEAS_RESIDENCE_CODES = [
    'GB', // United Kingdom
    'GG', // Guernsey
    'IM', // Isle of Man
    'JE', // Jersey
...
class CountriesCachedModel {
    ...
    _indexCountries() {
        ...
        this._overseasResidenceCountries = _.filter(
            countries,
            country => country.addressCountryFlag === true && !EXCLUDED_OVERSEAS_RESIDENCE_CODES.includes(country.countryCode)
        );
